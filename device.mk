...
# Fingerprint
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/idc/uinput-nav.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/uinput-nav.idc \
    $(LOCAL_PATH)/idc/uinput-fpc.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/uinput-fpc.idc \
    $(LOCAL_PATH)/keylayout/uinput-nav.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/uinput-egis.kl \
